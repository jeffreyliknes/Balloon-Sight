...
export function ScoreGauge({ score }: ScoreGaugeProps) {
  ...
  let colorClass = "text-primary"; // Coral (Fail)
  if (score >= 80) colorClass = "text-secondary"; // Sky Blue (Pass)
  else if (score >= 50) colorClass = "text-accent"; // Desert Orange (Warning)
