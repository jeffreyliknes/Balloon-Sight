            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12">
                 ...
                 <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                     <motion.div 
                        ...
                        viewport={{ once: true }}
                        transition={{ duration: 0.5, delay: 0.1 }}
                        className="bg-white p-8 rounded-xl h-64 flex flex-col justify-between hover:shadow-xl transition-shadow cursor-pointer group"
                     >
                ...
                <div className="max-w-6xl mx-auto px-6">
                    ...
                    >
                        ...
                        <div className="mt-12 bg-brand-primary/5 p-10 rounded-[32px] border-2 border-brand-primary/10 text-center relative overflow-hidden">
                            ...
                            >
                                Download Full AI Visibility Report — C$12
                            </Button>
